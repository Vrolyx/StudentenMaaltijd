            ...
            modelBuilder.Entity("StudentenMaaltijd.Entity.Entity.Meal", b =>
                {
                    ...
                    b.HasData(
                        new { MealId = 1, Description = "Super lekkere Chili", MaxAllowedGuests = 6, MealName = "Chili con carne", PreperationTime = new DateTime(2019, 1, 23, 21, 37, 33, 17, DateTimeKind.Local), Price = 7.00m },
                        new { MealId = 2, Description = "Super lekkere spaghetti", MaxAllowedGuests = 6, MealName = "Spaghetti", PreperationTime = new DateTime(2019, 1, 21, 21, 37, 33, 19, DateTimeKind.Local), Price = 2.00m },
                        new { MealId = 3, Description = "Super lekkere stampot", MaxAllowedGuests = 6, MealName = "Stampot", PreperationTime = new DateTime(2019, 1, 22, 21, 37, 33, 19, DateTimeKind.Local), Price = 5.00m }
                    );
                });
