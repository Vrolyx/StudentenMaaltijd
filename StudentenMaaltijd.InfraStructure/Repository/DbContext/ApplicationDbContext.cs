...
namespace StudentenMaaltijd.Entity.Repository.DbContext
{
    public class ApplicationDbContext : Microsoft.EntityFrameworkCore.DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Meal(){ MealId = 1, MealName = "Chili con carne", PreperationTime = DateTime.Now.AddDays(3), Description = "Super lekkere Chili", MaxAllowedGuests = 6, Price = 7.00m },
                new Meal(){ MealId = 2, MealName = "Spaghetti", PreperationTime = DateTime.Now.AddDays(1), Description = "Super lekkere spaghetti",MaxAllowedGuests = 6, Price = 2.00m },
                new Meal(){ MealId = 3, MealName = "Stampot", PreperationTime = DateTime.Now.AddDays(2), Description = "Super lekkere stampot", MaxAllowedGuests = 6, Price = 5.00m }
            };
            ...
            {
                new MealStudent() {MealStudentId = 1, StudentId = 3, MealId = 3, Role = "kok"},
                new MealStudent() {MealStudentId = 2,  StudentId = 1, MealId = 3, Role = "gast"},
                new MealStudent() {MealStudentId = 3,  StudentId = 2, MealId = 3, Role = "gast"},
                new MealStudent() {MealStudentId = 4,  StudentId = 4, MealId = 3, Role = "gast"},
            };
            ...
            modelBuilder.Entity<MealStudent>().HasData(mealStudentList.ToArray());
            modelBuilder.Entity<Student>().HasData(studentList.ToArray());
            modelBuilder.Entity<Meal>().HasData(mealList.ToArray());
        }
    }
}